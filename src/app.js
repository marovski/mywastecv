// A aplicação: rotas, middleware e templates.
//
// createApp recebe as suas dependências (a base de dados, o segredo da sessão) e
// devolve uma aplicação Express — não abre ficheiros, não semeia, não ouve numa
// porta e não instala guardas de processo. Isso é do ponto de entrada
// (server.js). É essa a costura: produção passa o ficheiro SQLite, os testes de
// HTTP passam ":memory:", e as rotas correm iguais nos dois casos.

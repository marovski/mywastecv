// Dados de exemplo para uma base de dados nova. Só o ponto de entrada da
// aplicação os aplica; os testes montam os seus próprios dados (test/helpers.js)
// para não dependerem de uma demonstração que muda.
